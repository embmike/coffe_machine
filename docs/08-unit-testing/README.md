...
For the board-side system-test layer, continue with:

- [docs/09-system-testing/README.md](C:/st_apps/coffee_machine/docs/09-system-testing/README.md)

## Test Strategy

The project uses two complementary test layers, but this chapter focuses only on the first one:

1. host-side C++ unit tests
2. board-side Python system tests
...
Board-side system tests are intended for:
